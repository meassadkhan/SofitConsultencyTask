...
::----------------------------------------------------------------------
:: Android StudioGameTools startup script.
::----------------------------------------------------------------------
...
SET BITS=64
SET _USER_JRE64_FILE=%APPDATA%\Google\AndroidGameDevelopmentTools\studio%BITS%.exe.jdk
SET BITS=
SET _USER_JRE_FILE=%APPDATA%\Google\AndroidGameDevelopmentTools\studio%BITS%.exe.jdk
IF "%JRE%" == "" (
  SET _JRE_CANDIDATE=
...
IF NOT EXIST "%JAVA_EXE%" (
  ECHO ERROR: cannot start Android StudioGameTools.
...
IF "%VM_OPTIONS_FILE%" == "" (
  ...
  IF EXIST "%APPDATA%\Google\AndroidGameDevelopmentTools\studio%BITS%.exe.vmoptions" (
    SET VM_OPTIONS_FILE=%APPDATA%\Google\AndroidGameDevelopmentTools\studio%BITS%.exe.vmoptions
  )
)
IF "%VM_OPTIONS_FILE%" == "" (
  ...
  IF EXIST "%APPDATA%\Google\AndroidGameDevelopmentTools\user.vmoptions" (
    SET USER_VM_OPTIONS_FILE=%APPDATA%\Google\AndroidGameDevelopmentTools\user.vmoptions
  )
)
...
SET CLASS_PATH=%CLASS_PATH%;%IDE_HOME%\plugins/android/lib/*
SET CLASS_PATH=%CLASS_PATH%;%IDE_HOME%\plugins/android/resources/*
SET CLASS_PATH=%CLASS_PATH%;%IDE_HOME%\plugins/java/lib/java-api.jar
SET CLASS_PATH=%CLASS_PATH%;%IDE_HOME%\plugins/java/lib/java-impl.jar
SET CLASS_PATH=%CLASS_PATH%;%IDE_HOME%\plugins/java/lib/resources.jar
SET CLASS_PATH=%CLASS_PATH%;%IDE_HOME%\plugins/java/lib/java_resources_en.jar
...
"%JAVA_EXE%" ^
  ...
  -Didea.vendor.name=Google -Didea.paths.selector=AndroidGameDevelopmentTools ^
  -Didea.platform.prefix=AndroidStudio -Didea.jre.check=true -Didea.platform.prefix=AndroidGameDevelopmentTools -Didea.load.plugins=false -Didea.initially.ask.config=force-not ^
